"""
Script to create a competition-ready submission file from the reduced feature predictions.
"""
...
def create_competition_submission():
    ...
    print("Creating competition-ready submission file from reduced feature predictions...")
    ...
    # Load our constrained predictions (246 antibodies)
    input_file = submissions_dir / "gdpa1_competition_submission_reduced_features_constrained.csv"
    if not input_file.exists():
        print(f"Error: Constrained predictions file not found at {input_file}")
        return False
    ...
    submission_df = pd.DataFrame({
        ...
        'AC-SINS_pH7.4': merged['AC-SINS_pH7.4'],
        'Tm2': merged['Tm2']
    })
    ...
    output_file = submissions_dir / "gdpa1_cross_validation_competition_submission_reduced_features.csv"
