...
# Import the FeatureIntegration class
try:
    from feature_integration import FeatureIntegration
except ImportError as e:
    print(f"Error importing FeatureIntegration: {e}")
    sys.exit(1)
...
def generate_complete_predictions():
    ...
    # Create FeatureIntegration instance
    ...
    try:
        ...
        # Save predictions
        output_file = submissions_dir / "gdpa1_cross_validation_competition_submission_complete.csv"
