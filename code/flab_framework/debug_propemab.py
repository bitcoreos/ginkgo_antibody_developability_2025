...
try:
    from flab_propemab import FLAbPROPERMAB
        ...
        FLAbPROPERMAB = object  # Fallback to avoid breaking the code
...
def debug_propemab_training():
    ...
    print("\nInitializing and training PROPERMAB:")
        # Check if FLAbPROPERMAB is available
    if FLAbPROPERMAB is object:
        print("FLAbPROPERMAB not available in public release")
        return
